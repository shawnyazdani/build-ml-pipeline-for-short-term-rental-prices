...
def go(args):
    ...
    # Getting Training/Validation artifact for training.
    ...
    #infer signature can't take in object dtype:
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    preprocessor = ColumnTransformer(
        ...
        remainder="drop",  # This drops the columns that we do not transform (eg IDs)
    )
