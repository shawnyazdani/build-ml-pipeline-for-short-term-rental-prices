...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            # Perform pre-processing/cleaning on dataset downloaded into W&B in prior step.
            _ = mlflow.run(
                os.path.join(hydra.utils.get_original_cwd(), "components", "basic_cleaning"),
                "main",
                parameters={
        ...
        if "data_check" in active_steps:
            # Perform data checks on dataset cleaned in prior step.
            _ = mlflow.run(
                os.path.join(hydra.utils.get_original_cwd(), "components", "data_check"),
                "main",
                parameters={
